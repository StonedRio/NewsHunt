...
public class OpinionsSelectionFragment extends Fragment {
    ...
    FollowingOpinionFragment followingOpinionFragment=new FollowingOpinionFragment();
    BrowseOpinionFragment browseOpinionFragment=new BrowseOpinionFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view= inflater.inflate(R.layout.fragment_opinions_selection, container, false);
        ...
        viewPager.setAdapter(new OpinionPagerAdapter(this));
    ...
    private class OpinionPagerAdapter extends FragmentStateAdapter {
        private static final int NUM_PAGES = 2;

        public OpinionPagerAdapter(@NonNull Fragment fragment) {
            super(fragment);
        }
        ...
        public Fragment createFragment(int position) {
            if (position == 0) {
                return followingOpinionFragment;
            } else {
                return browseOpinionFragment;
            }
        }
